...
class CloudSpeechClient:
    ...
    def _make_config(self, language_code, hint_phrases, punctuation):
    ...
    def recognize(self, language_code='en-US', hint_phrases=None, punctuation=True):
        streaming_config=speech.types.StreamingRecognitionConfig(
            config=self._make_config(language_code, hint_phrases, punctuation),
            single_utterance=True)
